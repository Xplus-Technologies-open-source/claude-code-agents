...
> Production-ready subagents for [Claude Code CLI](https://docs.anthropic.com/en/docs/claude-code) — 9 specialized agents covering security, code quality, testing, SEO, documentation, infrastructure, databases, API design, and AI code detection.
...
This project provides 9 battle-tested agents that cover the most common engineering needs, plus 15 knowledge skills that power each agent's domain expertise.
...
| **HumanForge** | HMN | Code Authenticity | `/hmn` | AI code detection, code humanization, git hygiene, commit validation |
...
/hmn                     AI code detection and humanization
```
...
| `validate-no-ai-mentions.sh` | HumanForge | Blocks git push/commit with AI mentions (Co-Authored-By, "generated by AI", etc.) |
...
|------|--------|----------|
| `plan` | CyberSentinel, GrowthForge, DataForge | Read-only. Can analyze and report but cannot modify files. |
| `acceptEdits` | CodeCraft, TestForge, HumanForge | Can propose and apply file edits with user approval. |
| Default | DocMaster, InfraForge, APIForge | Standard Claude Code permission model. |
...
│   └── humanforge.md               #   HMN — AI Code Detection
├── skills/                          # Invocation + knowledge skills
│   ├── sec/SKILL.md                 #   /sec (invocation)
│   ├── bpr/SKILL.md                 #   /bpr (invocation)
│   ├── tst/SKILL.md                 #   /tst (invocation)
│   ├── seo/SKILL.md                 #   /seo (invocation)
│   ├── doc/SKILL.md                 #   /doc (invocation)
│   ├── ops/SKILL.md                 #   /ops (invocation)
│   ├── db/SKILL.md                  #   /db (invocation)
│   ├── api/SKILL.md                 #   /api (invocation)
│   ├── hmn/SKILL.md                 #   /hmn (invocation)
│   ├── audit/SKILL.md               #   /audit (multi-agent pipeline)
│   ├── agents-status/SKILL.md       #   /agents-status (system check)
│   ├── security-review/SKILL.md     #   Knowledge: security checklist
│   ├── security-requirement-extraction/SKILL.md  # Knowledge: STRIDE/threat model
│   ├── solidity-security/SKILL.md   #   Knowledge: smart contract security
│   ├── frontend-design/SKILL.md     #   Knowledge: component architecture
│   ├── vercel-react-best-practices/SKILL.md  # Knowledge: React/Next.js
│   ├── api-design-principles/SKILL.md  # Knowledge: REST/GraphQL design
│   ├── python-design-patterns/SKILL.md  # Knowledge: Pythonic patterns
│   ├── python-performance-optimization/SKILL.md  # Knowledge: Python perf
│   ├── programmatic-seo/SKILL.md    #   Knowledge: pages at scale
│   ├── web-design-guidelines/SKILL.md  # Knowledge: UX/conversion
│   ├── seo-audit/SKILL.md           #   Knowledge: SEO scoring
│   ├── mcp-builder/SKILL.md         #   Knowledge: MCP development
│   ├── react-doctor/SKILL.md        #   Knowledge: React bug detection
│   ├── remotion-best-practices/SKILL.md  # Knowledge: Remotion video
│   └── ai-code-detection/SKILL.md   #   Knowledge: AI pattern catalog
...
│   └── validate-no-ai-mentions.sh   #   Blocks AI mentions in git (HMN)
├── templates/
